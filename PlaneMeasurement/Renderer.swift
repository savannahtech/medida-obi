...
final class Renderer {
        ...
        Task.init(priority: .utility) {
            do {
                ...
                do {
                    ...
                    case 1:
                        print("Error: No write permission for documents directory")
                    case 2:
                        print("Error: Failed to create JPEG data")
                    case 3:
                        print("Error: Invalid image (nil)")
                    case 4:
                        print("Error: Unable to determine available storage space")
                    case 5:
    ...
    func arrangeColorByte(color: simd_float1) -> UInt8 {
        ...
        Task.init(priority: .utility) {
            do {
                ...
                for i in 0..<currentPointCount {
                    ...
                    // For some reason, color.* could get values > 255, then it messes up opening the files in Python and CloudCompare. TODO understand why this happens initially.
                    let red = arrangeColorByte(color: colors.x * 255.0)
                    let green = arrangeColorByte(color: colors.y * 255.0)
                    let blue = arrangeColorByte(color: colors.z * 255.0)
